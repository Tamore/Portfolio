          ...
          <section id="work" className="space-y-8">
             ...
             <motion.div layout className="flex flex-wrap justify-center gap-6">
                ...
                {[
                  ...
                  { title: 'PitchControl', ident: 'SYS-110', tags: ['Next.js', 'AI'], category: 'Web', desc: 'Enterprise-grade AI operations simulation platform built for a hackathon.', color: '#28c941', icon: <Settings />, link: 'https://github.com/Tamore/PitchControl' },
                  { title: 'Mission 100', ident: 'UI-100', tags: ['Mobile-First', 'React'], category: 'Web', desc: 'High-performance, premium mobile-first landing page with dynamic carousels.', color: '#ffbd2e', icon: <Smartphone />, link: 'https://github.com/Tamore/Fifa-Challenge' },
